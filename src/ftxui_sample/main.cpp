...
// configuration step. It creates a namespace called `rms`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", rms::cmake::project_name, rms::cmake::project_version) };
